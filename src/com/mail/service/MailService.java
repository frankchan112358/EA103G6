...
public class MailService {
	...
	public void sendHTMLMail(String to,String subject, String messageText,String picLink) throws ServletException {
		try {
		   // 設定使用SSL連線至 Gmail smtp Server
		   Properties props = new Properties();
		   props.put("mail.smtp.host", "smtp.gmail.com");
		...
		String html="<!DOCTYPE html>\r\n" + 
				...
				"                                                    <tbody>\r\n" + 
				"                                                        <tr>\r\n" + 
				"                                                            <td style=\"width:150px\"><a href="+picLink+" target=\"_blank\" data-saferedirecturl=\"https://i.imgur.com/3AM005I.jpg\"><img height=\"auto\" src=\"https://i.imgur.com/3AM005I.jpg\" style=\"border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px\" width=\"150\" class=\"CToWUd\"> </a></td>\r\n" + 
				"                                                        </tr>\r\n" + 
				"                                                    </tbody>\r\n" + 
				"                                                </table>\r\n" + 
				"                                            </td>\r\n" + 
	...
	public void sendUpdatePSWMail(String to,String subject, String rendNum,String picLink)throws ServletException {
		try {
			   // 設定使用SSL連線至 Gmail smtp Server
			   Properties props = new Properties();
			   props.put("mail.smtp.host", "smtp.gmail.com");
