...
public class BanjiPostJNDIDAO implements BanjiPostDAO_interface {
	...
	// 查全部
	private static final String GET_ALL_STMT = "SELECT BANJIPOSTNO,BANJINO,TITLE,BANJIPOSTCONTENT,UPDATETIME,STATUS FROM BANJIPOST ORDER BY STATUS DESC,to_number(BANJIPOSTNO) DESC";
	// 查單個
