...
public class BanjiTypeJNDIDAO implements BanjiTypeDAO_interface {
	...
	// 查全部
	private static final String GET_ALL_STMT = "SELECT BANJITYPENO,BANJITYPENAME,CLASSHOURS,BANJITYPECONTENT,BANJITYPEENABLE FROM BANJITYPE  ORDER BY BANJITYPENO";
	// 查單個
