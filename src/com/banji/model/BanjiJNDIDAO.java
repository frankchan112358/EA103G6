...
public class BanjiJNDIDAO implements BanjiDAO_interface {
	...
	// 查全部(含結訓、刪除)
	private static final String GET_ALL_STMT = "SELECT BANJINO,EMPNO,BANJITYPENO,to_char(STARTDAY,'yyyy-mm-dd')STARTDAY,to_char(ENDDAY,'yyyy-mm-dd')ENDDAY,BANJINAME,CLASSHOURS,NUMBEROFSTUDENT,CLASSROOMNO,STATUS,BANJICONTENT FROM BANJI WHERE ISDELETE=0 ORDER BY to_number(BANJINO)";
	// 查單個
