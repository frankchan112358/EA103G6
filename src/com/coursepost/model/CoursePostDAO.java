...
public class CoursePostDAO implements CoursePostDAO_interface {
	...
	private static final String GET_COURSEPOST_BY_COURSENO = "SELECT COURSEPOSTNO, COURSENO, TITLE, POSTCONTENT, TO_CHAR(UPDATETIME,'YYYY-MM-DD HH24:MI:SS') UPDATETIME FROM COURSEPOST WHERE COURSENO =? ORDER BY UPDATETIME DESC";
