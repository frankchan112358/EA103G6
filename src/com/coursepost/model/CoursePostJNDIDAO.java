...
public class CoursePostJNDIDAO implements CoursePostDAO_interface {
	...
	private static final String GET_ALL_STMT = "SELECT COURSEPOSTNO, COURSENO, TITLE, POSTCONTENT, UPDATETIME FROM COURSEPOST ORDER BY UPDATETIME DESC";
