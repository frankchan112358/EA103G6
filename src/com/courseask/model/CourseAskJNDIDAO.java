...
public class CourseAskJNDIDAO implements CourseAskDAO_interface {
	...
	// 查全部
	private static final String GET_ALL_STMT = "SELECT COURSEASKNO,COURSENO,STUDENTNO,TITLE,QUESTION,UPDATETIME ,STATUS FROM COURSEASK WHERE ISDELETE=0 ORDER BY COURSEASKNO DESC";
	// 查單個
