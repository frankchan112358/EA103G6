...
.btn2 {
	...
	-webkit-box-shadow: inset 0 0px 0 rgba(255, 255, 255, 0.15), 0 0px 0px
		rgba(0, 0, 0, 0.075);
	box-shadow: inset 0 0px 0 rgba(255, 255, 255, 0.15), 0 0px 0px
		rgba(0, 0, 0, 0.075);
	font-size: 23px;
}
														...
														<div class="sb1">
															<a class=vpath videoNo="${videoSvc.getOneVideoWithTimetableNo(timetableVO.timetableNo).videoNo}" href="javascript:void(0)">
																<span class="video-title in-sb">
																	...
																	${timetableVO.timetableDate} ${timetableVO.periodText}
																</span>
															</a>
															<span class="in-sb-log">
																<button timeteableNo="${timetableVO.timetableNo}" type="button" class="btn btn-primary btn-pills waves-effect waves-themed btn1" style="font-size: 13px;">
