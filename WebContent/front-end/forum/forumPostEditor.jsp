            ...
            <div class="page-content-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item">${mode eq 'new' ? '新增貼文':'修改貼文'}</li>
                    </ol>
                    <div class="subheader">
                        <h1 class="subheader-title">
                            <i class='subheader-icon fal fa-comments-alt'></i>
                            ${mode eq 'new' ? '新增貼文':'修改貼文'}
                        </h1>
                    </div>
                            ...
                            <div class="panel-container show">
                                <div class="panel-content">
                                    <form method="post" action="<%=request.getContextPath() %>/forumPost/forumPost.do" name="form1" class="needs-validation" novalidate>
                                        <label for="forumTopicNo">討論版:</label>
                                        <select size="1" name="forumTopicNo">
                                            <c:forEach var="forumTopicVO" items="${studentVO.banjiVO.forumTopicList}">
                                                <option value="${forumTopicNo}" disabled>${forumTopicVO.forumTopicName}</option>
                                            </c:forEach>
                                        </select>
                                        <label for="forumTopicNo">貼文標題:</label>
                                        <input placeholder="請輸入貼文標題" name="title" style="color: black; width: 95%; height: 50px; margin: 20px ;" value="${forumPostVO.title }" required>
                                        <div class="invalid-feedback" style="padding-left:30px;">
                                            請勿空白.
                                        </div>
                                        <label for="forumTopicNo">貼文內容:</label>
