				...
				<main id="js-page-content" role="main" class="page-content">
					...
					<div class="btn-group mb-3" role="group">
						<c:forEach var="forumTopicVO" items="${forumtopicSvc.getByBanJiNo(studentVO.banjiNo)}">
							<button type="button" class="forumTopic btn btn-lg ${forumTopicVO.forumTopicNo == forumTopicNo ? 'btn-primary' : 'btn-outline-primary'} "
								forumTopicNo="${forumTopicVO.forumTopicNo}">
								<i class="fal fa-medal mr-1 fa-lg"></i>
								<span style="font-size:1.2em">${forumTopicVO.forumTopicName}</span>
							</button>
						</c:forEach>
					</div>
						...
						<div class="col-12">
							<div id="panel-1" class="panel">
								<div class="panel-hdr bg-primary-800 bg-success-gradient ">
									<h2 class="text-white">班級討論區總覽</h2>
								</div>
...
<!-- 										<div class="col-md-3"> -->
											<div id="heading2">
												<a href="<%=request.getContextPath()%>/front-end/forumpost/forumIndex_hot.jsp">
													<b>觀看數</b>
												</a>
											</div>
<!-- 										</div> -->
								...
								<div class="container">
									...
									<c:forEach var="forumPostVO" items="${list}" begin="<%=pageIndex%>" end="<%=pageIndex+rowsPerPage-1%>">
										...
										<div class="row">
											...
											<div class="col-md-2">
												<fmt:formatDate value="${forumPostVO.updateTime}" pattern="yyyy-MM-dd HH:mm:ss" />
											</div>
																	...
																	<div class="d-flex">
																		...
																		<div class="d-inline-flex flex-column">
																			...
																			<div class="d-block text-muted fs-sm">
																				<fmt:formatDate value="${forumPostVO.createTime}" pattern="yyyy-MM-dd HH:mm:ss" />
