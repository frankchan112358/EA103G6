                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-6 ml-auto mr-auto">
                                    <div class="card p-4 rounded-plus bg-faded">
                                        ...
                                        <form id="js-login"  method="post" action="<%=request.getContextPath() %>/ChangePassword/ChangePassword.do">    
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="password" id="emailverify" class="form-control" name="password" required>
                                                <div class="invalid-feedback">No, you missed this one.</div>
                                                
                                            </div>
                                            <div class="form-group">
                                                <label class="form-label" for="userpassword">密碼驗證</label>
                                                <input type="password" id="userpassword" class="form-control"  placeholder="請再次輸入您的新密碼" name="checkPassword" required>
