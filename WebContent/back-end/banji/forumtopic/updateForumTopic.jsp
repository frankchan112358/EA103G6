			...
			<div class="page-content-wrapper">
				...
				<main id="js-page-content" role="main" class="page-content">
					<ol class="breadcrumb page-breadcrumb">
						...
						<li class="breadcrumb-item">修改主題</li>
					</ol>
					<div class="subheader">
						<h1 class="subheader-title">
							<i class='subheader-icon fal fa-comments-alt'></i> 修改主題
						</h1>
					</div>
					<div class="row">
									...
									<div class="panel-content">
										<form METHOD="post" ACTION="<%=request.getContextPath()%>/banji/banji.forumtopic" name="form1" class="needs-validation" novalidate>
											<div class="form-group">
												...
												<input type="text" value="${forumTopicVO.forumTopicName}" name="forumTopicName" class="form-control" required placeholder="請輸入主題">
