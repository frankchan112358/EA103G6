            ...
            <div class="page-content-wrapper">
                ...
                <main id="js-page-content" role="main" class="page-content">
                    <ol class="breadcrumb page-breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<%=request.getContextPath()%>/banji/banji.leave?banjiNo=${banjiVO.banjiNo}">學員請假審核</a></li>
                                        ...
                                        <div class="card h-100 rounded overflow-hidden position-relative">
                                            ...
                                            <c:if test="${leaveVO.status == 0}">
                                                <div class="card-footer py-2 d-flex m-auto">
                                                    ...
                                                    <form id="rejectForm" method="post" action="<%=request.getContextPath()%>/banji/banji.leave" class="m-1">
