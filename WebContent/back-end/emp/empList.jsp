...
<body class="mod-bg-1 mod-nav-link header-function-fixed nav-function-top nav-mobile-push nav-function-fixed mod-panel-icon">
    ...
    <div class="page-wrapper">
       ...
       <div class="modal fade" id="addEmp" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">新增導師</h4>
                  ...
                  <form id="form-leave" class="needs-validation" method="post" action="<%=request.getContextPath()%>/user.do" novalidate>
                	...
                	<div class="modal-footer">
                    	...
                    	<button type="button" class="btn btn-primary" id="submitAddEmp">送出</button>
                	</div>
                </form>
            </div>
        </div>
