                                        ...
                                        <div class="panel-content">
                                            ...
                                            <form METHOD="post" ACTION="<%=request.getContextPath()%>/banjiType/banjiType.do" name="form1">
                                                 <div class="form-group">
                                                    <label class="form-label" for="simpleinput">輸入班種:</label>
                                                    <input type="text" id="simpleinput" class="form-control" placeholder="請輸入班級種類" name="banjiTypeName">
                                                     <font color=red>${errorMsgs.banjiTypeName}</font>
                                                </div>
                                               ...
                                               <font color=red>${errorMsgs.classHours}</font>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="banjiTypeContent" class="form-control" id="example-textarea" rows="5"placeholder="請輸入內容"></textarea>
                                               ...
                                               <select class="custom-select form-control" name="banjiTypeEnable">
													<option value="1" ${(banjiVO.status==1)?'selected':'' }>運行</option>
												</select>           
                                                <font color=red>${errorMsgs.banjiTypeEnable}</font>
                                                </div>
