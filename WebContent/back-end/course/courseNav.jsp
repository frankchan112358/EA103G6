...
<div id="panel-10" class="panel">
	<ul class="nav nav-pills nav-justified" role="tablist">
		...
		<li class="nav-item">
			<a class="nav-link" data-toggle="" href="" style="font-size: 15px">課程影片管理</a>
		</li>
		<li class="nav-item">
			<a class="nav-link" data-toggle="" href="#js_change_pill_justified-5" style="font-size: 15px">課程教材管理</a>
		</li>
	</ul>
