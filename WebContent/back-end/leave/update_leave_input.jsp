...
<title>請假資料修改 - update_leave_input.jsp</title>
...
<table id="table-1">
	<tr><td>
		 <h3>請假資料修改 - update_leave_input.jsp</h3>
...
<form method="post" action="<%=request.getContextPath() %>/leave/leave.do" name="form1">
	<table>
		<tr>
			<td>請假編號:<font color=red><b>*</b></font></td>
		...
		<tr>
			...
			<td>
				<textarea style="resize:none" name="description" rows="5" cols="47"><%=leaveVO.getDescription() %></textarea>
			</td>
		</tr>
		<tr>
			<td>
...
<input type="hidden" name="leaveNo" value="<%=leaveVO.getLeaveNo() %>">
